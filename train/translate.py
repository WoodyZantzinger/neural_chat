...
def train():
  ...
  en_train = "n_data/input_train.txt"
  fr_train = "n_data/output_train.txt"
  en_dev = "n_data/input_dev.txt"
  fr_dev = "n_data/output_train.txt"
  ...
  with tf.Session(config=config) as sess:
    ...
    # A scale is a list of increasing numbers from 0 to 1 that we'll use
